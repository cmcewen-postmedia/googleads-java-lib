 ...
 */
public class RateCardPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.RateCard>{
    /* The collection of rate cards contained within this page. */
    private com.google.api.ads.dfp.axis.v201708.RateCard[] results;
    ...
    public RateCardPage(
           com.google.api.ads.dfp.axis.v201708.RateCard[] results,
     ...
     */
    public com.google.api.ads.dfp.axis.v201708.RateCard[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.RateCard[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.RateCard getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.RateCard _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201708.RateCard> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201708.RateCard> emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201708.RateCard>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "RateCardPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "RateCard"));
