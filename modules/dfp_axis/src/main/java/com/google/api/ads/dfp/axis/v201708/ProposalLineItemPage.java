 ...
 */
public class ProposalLineItemPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.ProposalLineItem>{
    /* The collection of proposal line items contained within this
     * page. */
    private com.google.api.ads.dfp.axis.v201708.ProposalLineItem[] results;
    ...
    public ProposalLineItemPage(
           com.google.api.ads.dfp.axis.v201708.ProposalLineItem[] results,
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201708.ProposalLineItem[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.ProposalLineItem[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.ProposalLineItem getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.ProposalLineItem _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201708.ProposalLineItem> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201708.ProposalLineItem> emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201708.ProposalLineItem>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "ProposalLineItemPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "ProposalLineItem"));
