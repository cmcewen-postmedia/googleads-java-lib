 ...
 */
public class CustomTargetingKeyPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201802.CustomTargetingKey>{
     ...
     * page. */
    private com.google.api.ads.dfp.axis.v201802.CustomTargetingKey[] results;
    ...
    public CustomTargetingKeyPage(
           ...
           com.google.api.ads.dfp.axis.v201802.CustomTargetingKey[] results) {
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201802.CustomTargetingKey[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201802.CustomTargetingKey[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201802.CustomTargetingKey getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201802.CustomTargetingKey _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201802.CustomTargetingKey> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201802.CustomTargetingKey>emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201802.CustomTargetingKey>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "CustomTargetingKeyPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "CustomTargetingKey"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
