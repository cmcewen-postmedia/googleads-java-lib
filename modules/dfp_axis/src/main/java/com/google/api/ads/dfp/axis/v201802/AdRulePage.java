 ...
 */
public class AdRulePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201802.AdRule>{
    ...
    private com.google.api.ads.dfp.axis.v201802.AdRule[] results;
    ...
    public AdRulePage(
           ...
           com.google.api.ads.dfp.axis.v201802.AdRule[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201802.AdRule[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201802.AdRule[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201802.AdRule getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201802.AdRule _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201802.AdRule> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201802.AdRule>emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201802.AdRule>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "AdRulePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "AdRule"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
