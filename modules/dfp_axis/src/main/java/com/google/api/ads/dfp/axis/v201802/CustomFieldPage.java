 ...
 */
public class CustomFieldPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201802.CustomField>{
    ...
    private com.google.api.ads.dfp.axis.v201802.CustomField[] results;
    ...
    public CustomFieldPage(
           ...
           com.google.api.ads.dfp.axis.v201802.CustomField[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201802.CustomField[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201802.CustomField[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201802.CustomField getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201802.CustomField _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201802.CustomField> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201802.CustomField>emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201802.CustomField>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "CustomFieldPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "CustomField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
