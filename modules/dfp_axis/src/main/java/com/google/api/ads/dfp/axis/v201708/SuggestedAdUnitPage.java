 ...
 */
public class SuggestedAdUnitPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit>{
     ...
     * page. */
    private com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit[] results;
    ...
    public SuggestedAdUnitPage(
           ...
           com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit[] results) {
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit> emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201708.SuggestedAdUnit>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "SuggestedAdUnitPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "SuggestedAdUnit"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
