 ...
 */
public class ContentPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201802.Content>{
    ...
    private com.google.api.ads.dfp.axis.v201802.Content[] results;
    ...
    public ContentPage(
           ...
           com.google.api.ads.dfp.axis.v201802.Content[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201802.Content[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201802.Content[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201802.Content getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201802.Content _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "ContentPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "Content"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
