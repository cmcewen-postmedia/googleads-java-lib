 ...
 */
public class ReconciliationLineItemReportPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport>{
    /* The collection of {@link ReconciliationLineItemReport} objects
     * contained in this page. */
    private com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport[] results;
    ...
    public ReconciliationLineItemReportPage(
           com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport[] results,
     ...
     * contained in this page.
     */
    public com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport[] getResults() {
        return results;
    }
     ...
     * contained in this page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport>emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201802.ReconciliationLineItemReport>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "ReconciliationLineItemReportPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "ReconciliationLineItemReport"));
