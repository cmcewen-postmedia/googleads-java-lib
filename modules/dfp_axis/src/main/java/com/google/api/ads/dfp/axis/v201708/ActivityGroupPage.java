 ...
 */
public class ActivityGroupPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.ActivityGroup>{
    ...
    private com.google.api.ads.dfp.axis.v201708.ActivityGroup[] results;
    ...
    public ActivityGroupPage(
           ...
           com.google.api.ads.dfp.axis.v201708.ActivityGroup[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201708.ActivityGroup[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.ActivityGroup[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.ActivityGroup getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.ActivityGroup _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201708.ActivityGroup> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201708.ActivityGroup> emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201708.ActivityGroup>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "ActivityGroupPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "ActivityGroup"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
