 ...
 */
public class UserPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201802.User>{
    ...
    private com.google.api.ads.dfp.axis.v201802.User[] results;
    ...
    public UserPage(
           ...
           com.google.api.ads.dfp.axis.v201802.User[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201802.User[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201802.User[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201802.User getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201802.User _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "UserPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "User"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
