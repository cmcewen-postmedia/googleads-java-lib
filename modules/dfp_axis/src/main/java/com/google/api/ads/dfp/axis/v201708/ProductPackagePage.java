 ...
 */
public class ProductPackagePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.ProductPackage>{
    ...
    /* The collection of product packages contained within this page. */
    private com.google.api.ads.dfp.axis.v201708.ProductPackage[] results;
    ...
    public ProductPackagePage(
           ...
           com.google.api.ads.dfp.axis.v201708.ProductPackage[] results) {
    ...
    /**
     * Gets the totalResultSetSize value for this ProductPackagePage.
     * 
    ...
    /**
     * Sets the totalResultSetSize value for this ProductPackagePage.
     * 
    ...
    /**
     * Gets the startIndex value for this ProductPackagePage.
     * 
    ...
    /**
     * Sets the startIndex value for this ProductPackagePage.
     * 
    ...
    /**
     * Gets the results value for this ProductPackagePage.
     * 
     * @return results   * The collection of product packages contained within this page.
     */
    public com.google.api.ads.dfp.axis.v201708.ProductPackage[] getResults() {
        return results;
    }


    /**
     * Sets the results value for this ProductPackagePage.
     * 
     * @param results   * The collection of product packages contained within this page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.ProductPackage[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.ProductPackage getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.ProductPackage _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof ProductPackagePage)) return false;
        ProductPackagePage other = (ProductPackagePage) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ProductPackagePage.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "ProductPackagePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "ProductPackage"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
