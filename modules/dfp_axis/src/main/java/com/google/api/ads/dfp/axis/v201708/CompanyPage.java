 ...
 */
public class CompanyPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.Company>{
    ...
    private com.google.api.ads.dfp.axis.v201708.Company[] results;
    ...
    public CompanyPage(
           ...
           com.google.api.ads.dfp.axis.v201708.Company[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201708.Company[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.Company[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.Company getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.Company _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "CompanyPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "Company"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
