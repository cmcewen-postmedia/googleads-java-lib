 ...
 */
public class CreativeSetPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201802.CreativeSet>{
    ...
    private com.google.api.ads.dfp.axis.v201802.CreativeSet[] results;
    ...
    public CreativeSetPage(
           ...
           com.google.api.ads.dfp.axis.v201802.CreativeSet[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201802.CreativeSet[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201802.CreativeSet[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201802.CreativeSet getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201802.CreativeSet _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201802.CreativeSet> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201802.CreativeSet>emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201802.CreativeSet>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "CreativeSetPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "CreativeSet"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
