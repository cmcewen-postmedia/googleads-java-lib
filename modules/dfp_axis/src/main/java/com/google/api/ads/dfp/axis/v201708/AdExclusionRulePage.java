 ...
 */
public class AdExclusionRulePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.AdExclusionRule>{
    ...
    private com.google.api.ads.dfp.axis.v201708.AdExclusionRule[] results;

    public AdExclusionRulePage() {
    }

    public AdExclusionRulePage(
           java.lang.Integer totalResultSetSize,
           java.lang.Integer startIndex,
           com.google.api.ads.dfp.axis.v201708.AdExclusionRule[] results) {
    ...
    /**
     * Sets the totalResultSetSize value for this AdExclusionRulePage.
     * 
    ...
    /**
     * Gets the startIndex value for this AdExclusionRulePage.
     * 
    ...
    /**
     * Sets the startIndex value for this AdExclusionRulePage.
     * 
    ...
    /**
     * Gets the results value for this AdExclusionRulePage.
     * 
     * @return results   * The collection of audience segments contained within this page.
     */
    public com.google.api.ads.dfp.axis.v201708.AdExclusionRule[] getResults() {
        return results;
    }


    /**
     * Sets the results value for this AdExclusionRulePage.
     * 
     * @param results   * The collection of audience segments contained within this page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.AdExclusionRule[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.AdExclusionRule getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.AdExclusionRule _value) {
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof AdExclusionRulePage)) return false;
        AdExclusionRulePage other = (AdExclusionRulePage) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(AdExclusionRulePage.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "AdExclusionRulePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "AdExclusionRule"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
