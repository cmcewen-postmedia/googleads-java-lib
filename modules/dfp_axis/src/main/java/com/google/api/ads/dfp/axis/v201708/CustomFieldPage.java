 ...
 */
public class CustomFieldPage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.CustomField>{
    ...
    private com.google.api.ads.dfp.axis.v201708.CustomField[] results;
    ...
    public CustomFieldPage(
           ...
           com.google.api.ads.dfp.axis.v201708.CustomField[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201708.CustomField[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.CustomField[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.CustomField getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.CustomField _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "CustomFieldPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "CustomField"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
