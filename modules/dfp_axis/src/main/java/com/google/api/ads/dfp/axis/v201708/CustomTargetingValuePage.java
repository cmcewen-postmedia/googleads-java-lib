 ...
 */
public class CustomTargetingValuePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201708.CustomTargetingValue>{
     ...
     * page. */
    private com.google.api.ads.dfp.axis.v201708.CustomTargetingValue[] results;
    ...
    public CustomTargetingValuePage(
           ...
           com.google.api.ads.dfp.axis.v201708.CustomTargetingValue[] results) {
     ...
     * page.
     */
    public com.google.api.ads.dfp.axis.v201708.CustomTargetingValue[] getResults() {
        return results;
    }
     ...
     * page.
     */
    public void setResults(com.google.api.ads.dfp.axis.v201708.CustomTargetingValue[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201708.CustomTargetingValue getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201708.CustomTargetingValue _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201708.CustomTargetingValue> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201708.CustomTargetingValue> emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201708.CustomTargetingValue>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "CustomTargetingValuePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201708", "CustomTargetingValue"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
