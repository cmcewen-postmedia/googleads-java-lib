 ...
 */
public class CreativePage  implements java.io.Serializable , Iterable<com.google.api.ads.dfp.axis.v201802.Creative>{
    ...
    private com.google.api.ads.dfp.axis.v201802.Creative[] results;
    ...
    public CreativePage(
           ...
           com.google.api.ads.dfp.axis.v201802.Creative[] results) {
     ...
     */
    public com.google.api.ads.dfp.axis.v201802.Creative[] getResults() {
        return results;
    }
     ...
     */
    public void setResults(com.google.api.ads.dfp.axis.v201802.Creative[] results) {
        this.results = results;
    }

    public com.google.api.ads.dfp.axis.v201802.Creative getResults(int i) {
        return this.results[i];
    }

    public void setResults(int i, com.google.api.ads.dfp.axis.v201802.Creative _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.dfp.axis.v201802.Creative> iterator() {
        if (results == null) {
            return java.util.Collections.<com.google.api.ads.dfp.axis.v201802.Creative>emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.dfp.axis.v201802.Creative>asList(results).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "CreativePage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://www.google.com/apis/ads/publisher/v201802", "Creative"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
