 ...
 */
public class AdGroupAdPage  extends com.google.api.ads.adwords.axis.v201802.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201802.cm.AdGroupAd>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201802.cm.AdGroupAd[] entries;
    ...
    public AdGroupAdPage(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.AdGroupAd[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.AdGroupAd[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201802.cm.AdGroupAd[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.AdGroupAd getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201802.cm.AdGroupAd _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "AdGroupAdPage"));
