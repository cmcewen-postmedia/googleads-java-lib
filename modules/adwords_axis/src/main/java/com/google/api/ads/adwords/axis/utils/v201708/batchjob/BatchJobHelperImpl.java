...
package com.google.api.ads.adwords.axis.utils.v201708.batchjob;
...
import com.google.api.ads.adwords.axis.v201708.cm.BatchJobOpsServiceSoapBindingStub;
import com.google.api.ads.adwords.axis.v201708.cm.Operand;
...
class BatchJobHelperImpl
  ...
  BatchJobHelperImpl(BatchJobUploader uploader, BatchJobLogger batchJobLogger) {
    ...
    resultQName = new QName("https://adwords.google.com/api/adwords/cm/v201708", "MutateResult");
  }
  ...
  public BatchJobMutateResponse downloadBatchJobMutateResponse(String downloadUrl)
     ...
     */
    List<com.google.api.ads.adwords.axis.v201708.cm.MutateResult> cmMutateResults;
    try {
      cmMutateResults =
          deserializer.deserializeBatchJobMutateResults(
              new URL(downloadUrl),
              getServiceTypeMappings(),
              com.google.api.ads.adwords.axis.v201708.cm.MutateResult.class,
              resultQName);
    } catch (Exception e) {
//      batchJobLogger.logDownload(downloadUrl, null, e);
    ...
    for (com.google.api.ads.adwords.axis.v201708.cm.MutateResult cmMutateResult : cmMutateResults) {
