 ...
 */
public class UserListPage  extends com.google.api.ads.adwords.axis.v201708.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201708.rm.UserList>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201708.rm.UserList[] entries;
    ...
    public UserListPage(
           ...
           com.google.api.ads.adwords.axis.v201708.rm.UserList[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201708.rm.UserList[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201708.rm.UserList[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201708.rm.UserList getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201708.rm.UserList _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201708", "UserListPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/rm/v201708", "UserList"));
