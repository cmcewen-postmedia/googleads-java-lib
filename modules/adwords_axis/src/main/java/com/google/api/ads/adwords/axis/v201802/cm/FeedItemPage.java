 ...
 * call.
 */
public class FeedItemPage  extends com.google.api.ads.adwords.axis.v201802.cm.NullStatsPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201802.cm.FeedItem>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201802.cm.FeedItem[] entries;
    ...
    public FeedItemPage(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.FeedItem[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.FeedItem[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201802.cm.FeedItem[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.FeedItem getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201802.cm.FeedItem _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "FeedItemPage"));
