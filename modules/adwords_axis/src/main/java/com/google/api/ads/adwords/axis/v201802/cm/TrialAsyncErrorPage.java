 ...
 */
public class TrialAsyncErrorPage  extends com.google.api.ads.adwords.axis.v201802.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201802.cm.TrialAsyncError>{
    private com.google.api.ads.adwords.axis.v201802.cm.TrialAsyncError[] entries;
    ...
    public TrialAsyncErrorPage(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.TrialAsyncError[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201802.cm.TrialAsyncError[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201802.cm.TrialAsyncError[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.TrialAsyncError getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201802.cm.TrialAsyncError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "TrialAsyncErrorPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "TrialAsyncError"));
