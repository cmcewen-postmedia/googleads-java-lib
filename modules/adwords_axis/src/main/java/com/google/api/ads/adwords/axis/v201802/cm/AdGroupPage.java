 ...
 */
public class AdGroupPage  extends com.google.api.ads.adwords.axis.v201802.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201802.cm.AdGroup>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201802.cm.AdGroup[] entries;
    ...
    public AdGroupPage(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.AdGroup[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.AdGroup[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201802.cm.AdGroup[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.AdGroup getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201802.cm.AdGroup _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201802.cm.AdGroup> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201802.cm.AdGroup>emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201802.cm.AdGroup>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "AdGroupPage"));
