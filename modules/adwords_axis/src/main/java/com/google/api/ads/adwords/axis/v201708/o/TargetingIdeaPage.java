 ...
 */
public class TargetingIdeaPage  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201708.o.TargetingIdea>{
    ...
    private com.google.api.ads.adwords.axis.v201708.o.TargetingIdea[] entries;
    ...
    public TargetingIdeaPage(
           ...
           com.google.api.ads.adwords.axis.v201708.o.TargetingIdea[] entries) {
     ...
     */
    public com.google.api.ads.adwords.axis.v201708.o.TargetingIdea[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201708.o.TargetingIdea[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201708.o.TargetingIdea getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201708.o.TargetingIdea _value) {
     ...
     */
    @Override
    public java.util.Iterator<com.google.api.ads.adwords.axis.v201708.o.TargetingIdea> iterator() {
        if (entries == null) {
            return java.util.Collections.<com.google.api.ads.adwords.axis.v201708.o.TargetingIdea>emptyList().iterator();
        }
        return java.util.Arrays.<com.google.api.ads.adwords.axis.v201708.o.TargetingIdea>asList(entries).iterator();
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201708", "TargetingIdeaPage"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("totalNumEntries");
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201708", "totalNumEntries"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201708", "entries"));
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/o/v201708", "TargetingIdea"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
