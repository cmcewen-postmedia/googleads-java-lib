 ...
 */
public class BudgetPage  extends com.google.api.ads.adwords.axis.v201710.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201710.cm.Budget>{
    private com.google.api.ads.adwords.axis.v201710.cm.Budget[] entries;
    ...
    public BudgetPage(
           ...
           com.google.api.ads.adwords.axis.v201710.cm.Budget[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     * @return entries
     */
    public com.google.api.ads.adwords.axis.v201710.cm.Budget[] getEntries() {
        return entries;
    }
     ...
     * @param entries
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201710.cm.Budget[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201710.cm.Budget getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201710.cm.Budget _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "BudgetPage"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201710", "Budget"));
