 ...
 */
public class AdGroupCriterionPage  extends com.google.api.ads.adwords.axis.v201802.cm.Page  implements java.io.Serializable , Iterable<com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion>{
    /* The result entries in this page. */
    private com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion[] entries;
    ...
    public AdGroupCriterionPage(
           ...
           com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion[] entries) {
        super(
            totalNumEntries,
            pageType);
     ...
     */
    public com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion[] getEntries() {
        return entries;
    }
     ...
     */
    public void setEntries(com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion[] entries) {
        this.entries = entries;
    }

    public com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion getEntries(int i) {
        return this.entries[i];
    }

    public void setEntries(int i, com.google.api.ads.adwords.axis.v201802.cm.AdGroupCriterion _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("https://adwords.google.com/api/adwords/cm/v201802", "AdGroupCriterionPage"));
